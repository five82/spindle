...
| `log_retention_days` | Days to keep daemon/background/Drapto logs before pruning. | Default 60; set 0 to disable automatic cleanup. |
...
Daemon, background, and Drapto logs are pruned automatically when they exceed
