...
1. Transcribe each ripped title with Qwen3-ASR.
...
Ripped Episode Files
        |
        v
[1. Transcribe] -- Qwen3-ASR on selected primary audio
        |
        v
...
- the Qwen3-ASR transcript from the rip
