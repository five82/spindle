...
Workflow for turning optical discs into a Jellyfin ready library. Insert a disc and the daemon handles identification (TMDB), ripping (MakeMKV), encoding to AV1 (Drapto), optional subtitles (Qwen3-ASR + Qwen3-ForcedAligner transcription), organization, Jellyfin refreshes, and notifications.
